...
void  mockgl_DrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices)
{
...
void  mockgl_TexImage3D(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void * pixels)
{
...
void  mockgl_CompressedTexImage1D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void * data)
{
...
void  mockgl_CompressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void * data)
{
...
void  mockgl_CompressedTexImage3D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data)
{
...
void  mockgl_CompressedTexSubImage1D(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void * data)
{
...
void  mockgl_CompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void * data)
{
...
void  mockgl_GetCompressedTexImage(GLenum target, GLint lod, void * img)
{
...
void  mockgl_FogCoordPointer(GLenum type, GLsizei stride, const void * pointer)
{
...
void  mockgl_MultiDrawElements(GLenum mode, const GLsizei * count, GLenum type, const void *const * indices, GLsizei drawcount)
{
...
void  mockgl_SecondaryColorPointer(GLint size, GLenum type, GLsizei stride, const void * pointer)
{
...
void  mockgl_BufferData(GLenum target, GLsizeiptr size, const void * data, GLenum usage)
{
    return GlewMock::getMock()->gl_BufferData(target, size, data, usage);
}
PFNGLBUFFERDATAPROC __glewBufferData = mockgl_BufferData;

void  mockgl_BufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const void * data)
{
...
void  mockgl_GetBufferPointerv(GLenum target, GLenum pname, void ** params)
{
...
void  mockgl_GetBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, void * data)
{
...
void  mockgl_BlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha)
{
...
void  mockgl_DisableVertexAttribArray(GLuint index)
{
...
void  mockgl_EnableVertexAttribArray(GLuint index)
{
