#include "VertexShaderProgramLighting.h"
#include "Rendering/ShaderNode.h"
#include "Rendering/View.h"

NS_FT_BEGIN

const char* VertexShaderProgramLighting::fragment_shader_source_ = {
        "#version 140\n"
...
const char* VertexShaderProgramLighting::vertex_shader_source_ = {
        "#version 140\n\
...
VertexShaderProgramLighting::VertexShaderProgramLighting() {
...
bool VertexShaderProgramLighting::load() {
    if (!VertexColorShaderProgram::load())
        return false;
...
void VertexShaderProgramLighting::updateUniforms(const Camera *camera, ShaderNode *node) {
