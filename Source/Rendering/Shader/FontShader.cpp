...
const char* FontShader::fragment_shader_source_ = {
    "#version 140\n\
...
const char* FontShader::vertex_shader_source_ = {
    "#version 140\n\
...
FontShader::FontShader() : fill_color_uniform_id_(-1) {
...
bool FontShader::load() {
    if (!VertexTextureShaderProgram::load())
        return false;
    fill_color_uniform_id_ = glGetUniformLocation(program_id_, "fill_color");
    return fill_color_uniform_id_ != -1;
}

void FontShader::updateUniforms(const Camera *camera, ShaderNode *node) {
