...
Line::Line(const glm::vec2& p1, const glm::vec2& p2, float thickness, const glm::vec3& color, VertexShaderProgramColor* shader):
    Plane(glm::vec2(glm::length(p2 - p1), thickness), color, shader) {
    auto delta = p2 - p1;
