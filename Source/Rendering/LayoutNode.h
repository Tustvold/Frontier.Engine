...
public:
    ...
    void layoutChildrenWithPaddingX(float padding, bool reverse = false) {
        ...
        setBoundingShape(std::make_unique<BoundingCuboid>(glm::vec3(), glm::vec3(x, max_y, max_z)));
    ...
    void layoutChildrenWithPaddingY(float padding, bool reverse = false) {
        ...
        setBoundingShape(std::make_unique<BoundingCuboid>(glm::vec3(), glm::vec3(max_x, y, max_z)));
    }
    ...
    void layoutChildrenWithPaddingZ(float padding, bool reverse = false) {
        ...
        setBoundingShape(std::make_unique<BoundingCuboid>(glm::vec3(), glm::vec3(max_x, max_y, z)));
    }
    ...
    void layoutChildrenInGridXY(float padding, int maxX, int maxY) {
        ...
        setBoundingShape(std::make_unique<BoundingCuboid>(glm::vec3(), glm::vec3(max_x, ypos,0)));
    }
